import{j as l,h}from"./chunks/theme.fPrrFYEF.js";import{o as u,c as p,G as t,w as r,a as d,k as a,F as f,p as c,j as n,aq as T,B as v}from"./chunks/framework.Z42t_U4q.js";import{Q as b}from"./chunks/index.DEUECMle.js";const V=`<template>
  <VerGradientText
...
<\/script>
<style scoped lang="scss"></style>
`,y={__name:"size",setup(m){const s=c("md"),e=[{label:"XS",value:"xs"},{label:"SM",value:"sm"},{label:"MD",value:"md"},{label:"LG",value:"lg"}];return(i,o)=>(u(),p(f,null,[t(a(h),{modelValue:s.value,"onUpdate:modelValue":o[0]||(o[0]=x=>s.value=x),options:e},null,8,["modelValue"]),t(a(l),{size:s.value,type:"success"},{default:r(()=>o[1]||(o[1]=[d(" 哈哈哈哈 ")])),_:1},8,["size"]),t(a(l),{size:24,type:"error"},{default:r(()=>o[2]||(o[2]=[d("哈哈哈哈")])),_:1})],64))}},B=`<template>
