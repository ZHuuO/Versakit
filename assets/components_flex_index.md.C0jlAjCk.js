import{F as g,g as f,i as B,h as z}from"./chunks/theme.fPrrFYEF.js";import{d as V,o as m,b as h,w as u,c as p,C as W,j as e,F as v,k as r,_ as C,p as b,h as Z,G as t,a as s,a8 as w,a9 as X,B as k}from"./chunks/framework.Z42t_U4q.js";import{Q as c}from"./chunks/index.DEUECMle.js";const A=`<script setup lang="ts">
...
`,G=V({__name:"wrap",setup(y){return(n,l)=>(m(),h(r(g),{wrap:"wrap"},{default:u(()=>[(m(),p(v,null,W(20,a=>e("div",{key:a,class:"flex-item"})),64))]),_:1}))}}),F=C(G,[["__scopeId","data-v-cdede82c"]]),S=`<script setup lang="ts">
...
`,D=V({__name:"gap",setup(y){const n=b("small"),l=b(16),a=Z(()=>n.value==="custom"?l.value:n.value);return(i,d)=>(m(),p(v,null,[e("div",null,[t(r(f),{label:"small",modelValue:n.value,"onUpdate:modelValue":d[0]||(d[0]=o=>n.value=o)},{default:u(()=>d[5]||(d[5]=[s("small")])),_:1},8,["modelValue"]),t(r(f),{label:"middle",modelValue:n.value,"onUpdate:modelValue":d[1]||(d[1]=o=>n.value=o)},{default:u(()=>d[6]||(d[6]=[s("middle")])),_:1},8,["modelValue"]),t(r(f),{label:"large",modelValue:n.value,"onUpdate:modelValue":d[2]||(d[2]=o=>n.value=o)},{default:u(()=>d[7]||(d[7]=[s("large")])),_:1},8,["modelValue"]),t(r(f),{label:"custom",modelValue:n.value,"onUpdate:modelValue":d[3]||(d[3]=o=>n.value=o)},{default:u(()=>d[8]||(d[8]=[s("custom")])),_:1},8,["modelValue"]),w(t(r(B),{modelValue:l.value,"onUpdate:modelValue":d[4]||(d[4]=o=>l.value=o)},null,8,["modelValue"]),[[X,n.value==="custom"]])]),t(r(g),{gap:a.value,style:{"margin-top":"10px"}},{default:u(()=>[(m(),p(v,null,W(4,o=>e("div",{key:o,class:"flex-item"})),64))]),_:1},8,["gap"])],64))}}),T=C(D,[["__scopeId","data-v-a34ec277"]]),J=`<script setup lang="ts">
import { ref } from 'vue'
