import{m as l,y as b}from"./chunks/theme.fPrrFYEF.js";import{d as f,p,o as u,c as d,G as e,k as t,j as s,_ as y,w as o,a as i,B as g}from"./chunks/framework.Z42t_U4q.js";import{Q as m}from"./chunks/index.DEUECMle.js";const B=`<template>
  <div>
...
<\/script>
`,_=f({__name:"animation",setup(v){const r=p(0);return setInterval(()=>{r.value=r.value>=100?0:r.value+10},1e3),(n,c)=>(u(),d("div",null,[e(t(l),{animation:!0,percent:r.value},null,8,["percent"]),s("div",null,[e(t(l),{animation:!0,type:"circle",percent:r.value},null,8,["percent"])])]))}}),X=`<template>
  <div>
...
`,Z=f({__name:"circle",setup(v){const r=p(75);return(n,c)=>(u(),d("div",null,[e(t(l),{type:"circle",percent:r.value},null,8,["percent"]),e(t(l),{type:"circle",percent:r.value,status:"success"},null,8,["percent"]),e(t(l),{type:"circle",percent:r.value,status:"error"},null,8,["percent"])]))}}),C=y(Z,[["__scopeId","data-v-06a138a2"]]),W=`<template>
  <div>
    <VerProgress :percent />
