import{$ as d,D as b,h as C}from"./chunks/theme.fPrrFYEF.js";import{d as x,o as i,b as y,w as s,G as n,a as l,k as a,_ as v,p as B,c,j as t,B as f}from"./chunks/framework.Z42t_U4q.js";import{Q as p}from"./chunks/index.DEUECMle.js";const V=`c
...
`,X=x({__name:"truncated",setup(m){return(u,e)=>(i(),y(a(b),null,{default:s(()=>[n(a(d),{class:"w-100px",truncated:""},{default:s(()=>e[0]||(e[0]=[l("Self element set width 100px")])),_:1})]),_:1}))}}),D=v(X,[["__scopeId","data-v-b0d361fa"]]),T=`<script setup lang="ts">
import { ref } from 'vue'
